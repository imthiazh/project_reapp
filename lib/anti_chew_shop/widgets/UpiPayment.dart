    ...
    return MaterialApp(
      ...
      home: Container(
        ...
        child: Scaffold(
          ...
          appBar: GradientAppBar(title: Text('UPI Payment'),
          ...
          body: SafeArea(
            child: Container(
              ...
              child: ListView(
                children: <Widget>[
                  SizedBox(height: 40),
                  Text("  Payment Details", style: TextStyle(fontSize: 20,fontFamily: 'OpenSans',color:Colors.white)),
                  Container(
      ...
      borderSide: new BorderSide(color: Colors.white, width: 10)
                  ...
                  SizedBox(height: 40),
                  Text("  Payment Gateway", style: TextStyle(fontSize: 20,fontFamily: 'OpenSans',color:Colors.white)),
                  Container(
